...
//OR (|| o or): delvuelve true si al menos una de las expresiones es verdadera
...
//AND lógico (&&). Delvuelve true si ambos operadores son ciertos
echo "AND lógico (&&): <br>";
// echo (int)($a && $b) ."<br>";
// echo ($a && %c). "<br>";
if ($a && $b ){
